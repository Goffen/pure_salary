...
Tinker with percentages and salary

## Using `eframe template`

This projects is forked from emilk/eframe_template
...
> To enable Github Pages, you need to go to Repository -> Settings -> Pages -> Source -> set to `gh-pages` branch
> and `/` (root).
>
